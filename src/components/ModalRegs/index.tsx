...
import { ModalRegsClose, ModalRegsHeader, ModalRegsTitle } from "./style";
...
const ModalRegs = () => {
  ...
  return (
    <FormStyle onSubmit={handleSubmit(createContact)}>
      <ModalRegsHeader>
        <ModalRegsTitle>Cadastrar Contato</ModalRegsTitle>
        <ModalRegsClose
          onClick={(e: any) => [e.preventDefault(), setModalCreat(false)]}
        >
          x
        </ModalRegsClose>
      </ModalRegsHeader>
